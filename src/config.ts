...
export const siteConfig: SiteConfig = {
	...
	banner: {
		...
		homeText: {
			...
			subtitle: [
				"把每一天都当作可以重新命名的草稿。",
				"温柔不是因为软弱，而是看过了锋利之后的选择。",
				"偶尔允许自己慢下来，才是对时间最大的尊重。",
				"记录不是为了被看见，是为了不忘却当时的光。",
				"像整理书架一样整理自己的念头。",
				"不必追赶所有人，在自己的节奏里走完全程就好。",
				"有些答案不在远处，就在你敲下第一个字的瞬间。",
				"保持开放，像未完成的草稿那样勇敢。",
				"白天属于世界，深夜属于自己未说完的话。",
				"把偶然的灵感折成纸船，放进安静的河流。",
				"不追逐热点，只追逐自己的好奇心。",
				...
				"别怕走得慢，怕的是原地站。",
				"记录不是为了被看见，而是为了不忘记。",
				"人是在一次次选择“再试一次”里长出新骨头的。",
				"温柔不是软弱，是知世故而不世故。",
				"让自己变得更好，不是为了证明给谁看。",
				"把期待降到最低，所有遇见都是礼物。",
				"时间不语，却回答了所有问题。",
				"你认真做过的事，会在未来的某一天回来拥抱你。",
				"世界偶尔薄凉，内心也要繁花似锦。",
				"慢慢来，谁不是用尽全力过着平凡的一生。",
				"接纳所有的不完美，然后继续向前。",
				"真正的平静，不是避开车马喧嚣，而是在心中修篱种菊。",
				"别让任何人打乱你的人生节奏。",
				"读书不是为了雄辩和反驳，而是为了思考和权衡。",
				"允许事与愿违，因为更好的安排往往在后面。",
				"生活原本沉闷，但跑起来就有风。",
				"日落尤其温柔，人间皆是浪漫。"
			],
